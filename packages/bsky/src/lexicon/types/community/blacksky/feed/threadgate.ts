...
const is$typed = _is$typed,
  validate = _validate
const id = 'community.blacksky.feed.threadgate'

export interface Main {
  $type: 'community.blacksky.feed.threadgate'
  /** Reference (AT-URI) to the community post record. */
  post: string
...
/** Allow replies from actors mentioned in the post. */
export interface MentionRule {
  $type?: 'community.blacksky.feed.threadgate#mentionRule'
}
...
export interface FollowerRule {
  $type?: 'community.blacksky.feed.threadgate#followerRule'
}
...
export interface FollowingRule {
  $type?: 'community.blacksky.feed.threadgate#followingRule'
}
...
export interface ListRule {
  $type?: 'community.blacksky.feed.threadgate#listRule'
  list: string
}
